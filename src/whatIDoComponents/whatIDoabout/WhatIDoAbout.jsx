  ...
  return (
    <section className="about section container" id="about">
      ...
      <AboutContainer className="about__container  grid">
        <Img src={AboutImg} alt="" className="about__img" srcset="" />
        <AboutData className="about__data">
          <AboutTitle className="section__title">agriprenuership</AboutTitle>
          <DotContainer>
            <Dot />
            <Dot />
            <Dot />
      ...
      <AboutContainer className="about__container  grid">
        <Img src={AboutImg} alt="" className="about__img" srcset="" />
        <AboutData className="about__data">
          <AboutTitle className="section__title">Public Speaker</AboutTitle>
          <DotContainer>
            <Dot />
            <Dot />
            <Dot />
      ...
      <AboutContainer className="about__container  grid">
        <Img src={AboutImg} alt="" className="about__img" srcset="" />
        <AboutData className="about__data">
          <AboutTitle className="section__title">
            pastoral counseling
          </AboutTitle>
          <DotContainer>
            <Dot />
