...
const HomeSubtitle = styled.h3`
  ...
  animation: typewriter 5s infinite;
  color: var(--container-color);
...
const Data = () => {
  const [roles, setRoles] = useState(["Speaker", "Agripreneur"]);
  ...
  return (
    <div className="home__data">
      <HomeTitle className="home__title">Olushola Mark Obikanye</HomeTitle>
      <svg
        width="36"
        height="36"
        viewBox="0 0 48 48"
      ...
      <HomeSubtitle className="home__subtitle">
        {roles[currentIndex]}
      </HomeSubtitle>
      <HomeDescription className="home__description">
